package com.joblessgod.tutorial.Inventories;
...
public class SelectionScreen implements InventoryHolder {
    ...
    public SelectionScreen() {
        inv = Bukkit.createInventory(this, 9, "Selection Screen"); //Size: 9 | 18 | 27 | 36 | 45 | 54
        init();
    }
    ...
    private void init() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            item = createItem("§bMake a selection", Material.BOOK, lore);
